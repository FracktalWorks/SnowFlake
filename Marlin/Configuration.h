...
#define CUSTOM_MENDEL_NAME "Snowflake"
...
// Ultimaker2
    #define  DEFAULT_Kp 3.07
    #define  DEFAULT_Ki 0.06
    #define  DEFAULT_Kd 3.94
...
#define DISABLE_E false // For all extruderss
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,503.94,282}  // default steps per unit for ultimaker2
...
#define EXTRUDER_OFFSET_Y {0.0, -6.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
